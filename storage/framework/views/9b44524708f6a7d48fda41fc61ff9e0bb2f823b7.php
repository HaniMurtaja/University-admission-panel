<?php $__env->startSection('title','Edit University'); ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form role="form" action="<?php echo e(route('admin.universities.update',$university->id)); ?>" method="post"
                              class="col-sm-12"
                            ...
                            <div class="row col-md-3 col-sm-12 float-left">
                                <div class="col-sm-12">
                                    <div class="">
                                        <p>University Logo</p>
                                        <span style="color: red; font-size: 10px;">Keep Empty if you dont want to change it</span>
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" name="name" class="form-control" placeholder="Name"
                                               value="<?php echo e($university->name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="number" step="0.5" name="founding_year" class="form-control"
                                               placeholder="Year" value="<?php echo e($university->founding_year); ?>">
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" name="institution_type" class="form-control"
                                               ...
                                               value="<?php echo e($university->institution_type); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 mt-5">
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" name="website" class="form-control"
                                               placeholder="URL" value="<?php echo e($university->website); ?>">
                                    </div>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <textarea name="about" class="form-control" rows="5"
                                                  placeholder="About"><?php echo e($university->about); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
...
<?php echo $__env->make('layouts.control_panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Web_Developer\Php\Laravel\Admission Panel\hani-master\resources\views/Admin/University/edit.blade.php ENDPATH**/ ?>