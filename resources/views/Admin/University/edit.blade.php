            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form role="form" action="{{route('admin.universities.update',$university->id)}}" method="post"
                              class="col-sm-12"
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="input-group @error('founding_year') has-danger @enderror">
                                        <input type="number" step="0.5" name="founding_year" class="form-control"
                                               placeholder="Year" value="{{ $university->founding_year }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 mt-5">
                                    ...
                                    <div class="input-group @error('website') has-danger @enderror">
                                        <input type="text" name="website" class="form-control"
                                               placeholder="URL" value="{{ $university->website }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mt-5 @error('about') has-danger @enderror">
                                        ...
                                        <textarea name="about" class="form-control" rows="5"
                                                  placeholder="About">{{ $university->about }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
