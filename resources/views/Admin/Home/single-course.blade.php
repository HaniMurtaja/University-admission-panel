                ...
                <div class="col-md-7 text-center">
                    ...
                    <div class="mb-5 element-animate">
                        ...
                        <p class="bcrumb"><a href="{{route('home')}}">Home</a> <span
                                class="sep ion-android-arrow-dropright px-2"></span> <a href="{{route('courses')}}">Course</a>
                            <span class="sep ion-android-arrow-dropright px-2"></span> <span
                                class="current">{{$course->name}}</span>
                        </p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-8 order-md-2 mb-5">
                    <div class="row">
                        <div class="col-md-12 text-center mb-5">
                            <img src="{{$course->university->imagePath()}}" alt="" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4 order-md-1">
                    ...
                    <div class="block-29 mb-5">
                        ...
                        <ul>
                            <li><span class="text-1">Course Name : </span> <span class="text-2">{{$course->name}}</span>
                            </li>
                            <li><span class="text-1">University : </span> <span
                                    class="text-2">{{$course->university->name}}</span></li>
                            <li><span class="text-1">Tuition Fees : </span> <span
                                    class="text-2">{{$course->fees}}$</span></li>
                            <li><span class="text-1">Course Type : </span> <span
                                    class="text-2">{{$course->type->name}}</span></li>
                            <li><span class="text-1">Duration : </span> <span
                                    class="text-2">{{$course->duration}} {{$course->duration > 1 ? 'Months':'Month'}}</span>
                            </li>
                        </ul>
                        <form action="{{route('selected_courses.store',$course->id)}}" method="POST"
                              style="display: none;" id="save-course{{$course->id}}">
                            @csrf
                        </form>
                        <button onclick="saveCourse({{$course->id}})" class="btn btn-primary">Apply Now</button>
                    </div>
